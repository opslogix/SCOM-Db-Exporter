...
namespace ScomDbExporter.Models
{
    ...
    public class PerfSample { public double Value; public DateTime Timestamp; public CounterInfo Counter; public EntityInfo Entity; public string InstanceName; }
    public class MappingFile { public List<MappingEntry> Mappings { get; set; } }
    public class MappingEntry { public string ObjectName; public string CounterName; public string InstanceName; public string MetricName; public Dictionary<string, string> Labels; public double ValueMultiplier; }
