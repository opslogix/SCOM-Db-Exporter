...
namespace ScomDbExporter.Models
{
    ...
    public class EntityInfo { public Guid BaseManagedEntityId; public string DisplayName; public string Path; public string FullName; public string TypeName; public bool Missing; }
